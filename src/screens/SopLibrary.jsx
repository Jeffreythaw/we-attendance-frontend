...
.we-sop-modal{position:fixed;inset:0;z-index:1000;display:grid;place-items:center;padding:20px;background:rgba(2,8,22,.7);backdrop-filter:blur(4px);}.we-sop-preview{width:min(880px,100%);max-height:min(82vh,900px);display:grid;grid-template-rows:auto 1fr;overflow:hidden;border:1px solid #cbd8e7!important;border-radius:16px;background:#fff!important;box-shadow:0 24px 70px rgba(0,0,0,.34);color:#142949!important;color-scheme:light;}.we-sop-previewHead{display:flex;justify-content:space-between;gap:16px;padding:18px 20px;border-bottom:1px solid #d9e3ef!important;background:#f5f8fc!important;}.we-sop-previewHead span{font-size:10px;font-weight:900;letter-spacing:.08em;color:#60738d!important;}.we-sop-previewHead h2{margin:5px 0 0;font-size:20px;color:#142949!important;}.we-sop-previewActions{display:flex;align-items:center;gap:10px;}.we-sop-previewActions label{display:grid;gap:3px;font-size:10px;font-weight:900;letter-spacing:.06em;color:#60738d!important;}.we-sop-previewActions select{min-width:112px;border:1px solid #b9c9dc!important;border-radius:8px;background:#fff!important;color:#142949!important;padding:6px 8px;font:inherit;letter-spacing:normal;}.we-sop-previewActions select:disabled{opacity:.55;}.we-sop-previewHead button{width:32px;height:32px;border:0;border-radius:50%;background:#e7eef7!important;color:#142949!important;font-size:24px;line-height:1;cursor:pointer;}.we-sop-preview pre{overflow:auto;margin:0;padding:22px 24px;white-space:pre-wrap;background:#fff!important;color:#142949!important;font:14px/1.65 "SF Pro Text",-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;}
